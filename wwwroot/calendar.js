var cal = {
    ...
    getSelectedRow : function(val)
    {
        db.transaction(function(transaction) {
           var attendance = transaction.executeSql("SELECT * FROM AttendanceLog where AttendanceLog.Date==getDate ",[], selectedRowValues, errorHandler);
    ...
    show : function (el) {
        ...
        var getDate= cal.sDay + "." + cal.sMth + "." + cal.sYear;
        var tForm = "<div>" + cal.sDay + " " + cal.mName[cal.sMth] + " " + cal.sYear + "</div>";
